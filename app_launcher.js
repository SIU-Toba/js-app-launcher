...
var appLauncher = new function () {
    ...
    this.init = function (appLauncherDataParam) {        
        ...
        var html_usuario = "<div id='container_datos_usuario'>";
            ...
            html_usuario += "               <div id='usuario_foto'></div>";
            html_usuario += "               <div id='usuario_cuenta'>";
            html_usuario += "                   <div id='usuario_cuenta_nombre'></div>";
            html_usuario += "                   <div id='usuario_cuenta_id'></div>";    
            html_usuario += "                   <div id='usuario_cuenta_botones'>";
            html_usuario += "                       <div id='usuario_cuenta_perfil'></div>";
            html_usuario += "                       <div id='usuario_preferencias'></div>";
            html_usuario += "                       <div id='usuario_cuenta_salir'></div>";
            html_usuario += "                   </div>";
            html_usuario += "               </div>";
            html_usuario += "           </div>";
            html_usuario += "       </div>";
